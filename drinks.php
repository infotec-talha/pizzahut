...
$select_product=select_product("drinks");
?>
...
<div _ngcontent-stv-c21="" class="col-6 col-sm-4 col-md-4 col-lg-3 px-1 product-card-wrapper">
    <div _ngcontent-stv-c21="" class="card mt-2 product-card">
        <div _ngcontent-stv-c21="" clas="crdTop">
            <img _ngcontent-stv-c21="" class="card-img-top bg-dark" min-height="100px" width="100%" src="<?='data:image/jpeg;base64,'.base64_encode( $row['image'] );?>" alt="Pepsi"></div>
            <div _ngcontent-stv-c21="" class="card-body px-2">
                <div _ngcontent-stv-c21="" class="title h5 mb-1 text-capitalize product-name"><?=$row['name'];?></div>
                <div _ngcontent-stv-c21="" class="col-dblock product-descripton"><p _ngcontent-stv-c21="" class="card-text col-12 px-1"><?=$row['product_description'];?></p></div>
                <div _ngcontent-stv-c21="" class="d-block pt-4 pt-md-2 pb-1 "> Select Size &amp; Type </div>
                <select class="browser-default custom-select" name="size">
                    <option _ngcontent-stv-c21="" value="<?=$row['size'] ? 'selected' : ''; ?>"> <?=$row['size'];?> </option>
                    </select></div>
        <div _ngcontent-stv-c21="" class="card-footer bg-white border-0 px-2"><button _ngcontent-stv-c21="" class="btn btn-sm btn-block btn-success d-block py-2"><div _ngcontent-stv-c21="" class="row p-0 m-0">
                    <div _ngcontent-stv-c21="" class="col-6 p-0 m-0 text-center text-md-right"> Add </div><!----><div _ngcontent-stv-c21="" class="col-6 p-0 m-0 float-right text-right"> Rs.<?=$row['price']?></div><!---->
                </div>
            </button>
