        ...
        <div _ngcontent-stv-c18="" class="card-body px-2">
            ...
            <div _ngcontent-stv-c18="" class="col-dblock product-descripton">
                ...
                <select class="browser-default custom-select">
                    <option _ngcontent-stv-c18="" value="<?=$row['size'] ? 'selected' : ''; ?>"> <?=$row['size'];?>   </option>
                   
                </select>
        </div>
        <div _ngcontent-stv-c18="" class="card-footer bg-white border-0 px-2">
            <button _ngcontent-stv-c18="" class="btn btn-sm btn-block btn-success d-block py-2">
                <div _ngcontent-stv-c18="" class="row p-0 m-0">
                    <div _ngcontent-stv-c18="" class="col-6 p-0 m-0 text-center text-md-right"> Add </div><!---->
                    <div _ngcontent-stv-c18="" class="col-6 p-0 m-0 float-right text-right"> Rs.<?=$row['price']?></div><!---->
                </div></button>
